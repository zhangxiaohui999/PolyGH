...
cellpath=/data/zhangxiaohui/01.Backups/04_potato/02.assem/00.Gamete_binning/s7_individual_nuclei_extraction
cd ${cellpath}
marker=/data/zhangxiaohui/01.Backups/04_potato/02.assem/00.Gamete_binning/s4_marker_creation/cnv_winsize10000_step10000_hq_merged_vs_hifi_markers_myresult_wsize50kb_final.txt
MQ=1
for sample in B;do
	while read r;do
		echo -e ${sample}"\t"${r}
