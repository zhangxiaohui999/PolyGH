...
if __name__ == '__main__':
    ...
    # 0 ln -s hic_new/hic_normal.txt result.hic.normal.txt
    ...
    # 用python逐行读取文件，每48行为一组，按照这48行的最后一列数据进行从大到小排序
    # 数据格式如下utg000005l_pilon_1_10000 in list1 : utg000005l_pilon_1_10000  utg000134l_pilon  0.5814176278223575
